...
const FeaturedDestination = () => {
  ...
  return (
    ...
    <Title title="Featured Destination" subtitle="Discover our handpicked seletion of exceptional properties around the world, offering unparalled luxury and unforgettable experience." />
