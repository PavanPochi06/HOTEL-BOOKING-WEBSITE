...
const NewsLetter = () => {
    return (
        <div className="flex flex-col items-center max-w-3xl lg:w-full rounded-2xl px-4 py-8 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">

            <Title title="Stay Inspired" subtitle="Join our newsletter and be the first to discover new updates, exclusive offers, and travel inspiration." />
